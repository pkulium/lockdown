...
def train_mask(id, global_model, criterion, train_loader, mask_lr, anp_eps, anp_steps, anp_alpha, round):
        ...
        save_mask_scores(local_model.state_dict(), f'/work/LAS/wzhang-lab/mingl/code/backdoor/lockdown/src/save/mask_values{id}.txt')
        mask_values = read_data(f'/work/LAS/wzhang-lab/mingl/code/backdoor/lockdown/src/save/mask_values{id}.txt')
